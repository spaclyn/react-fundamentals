        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Refractor the text on this page and make this your own project.</li>
                    <li>This app simply scratches the surface on what is possible with React.</li>
                    <li>We have tried to collect the very best resources for this app, and we have cited those in <Link to="/resources">here</Link></li>
